      ...
      description: (
        <text>
          ...
          <p>
            ...
            fiz o mapeamento no Google Search Console, para indexar e mostrar as
          ...
          <p>
            ...
            divulgação que o google proporciona. A melhorar o SEO e colocar
            palavras chaves, sendo em texto ou em alternative text nas images.
          </p>
        </text>
      ),
      name: 'RF-REBOQUE',
